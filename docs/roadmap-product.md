...
- ⬜ `L` **Soirée récurrente** : option à la création pour définir une récurrence (hebdomadaire, bimensuelle, mensuelle) ; à chaque occurrence, une nouvelle soirée est créée automatiquement avec la même configuration et les mêmes participants invités ; l'hôte peut arrêter la récurrence à tout moment.
