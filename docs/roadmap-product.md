...
- ✅ **Intégration Letterboxd** (2026-08-09) : import de la watchlist depuis un export CSV Letterboxd (recherche TMDB par titre/année, écran de revue des correspondances) ; synchronisation automatique via le flux RSS public (retrait de la watchlist Movie Picker des films marqués vus sur Letterboxd).
