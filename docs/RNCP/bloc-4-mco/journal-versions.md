...
|---------|------|-------------------|
| **1.6.0** | 12/09/2026 | Soirées récurrentes, modèles de soirée, plusieurs films gagnants, limite de votes, recherche de comptes, watchlist des amis |
| 1.5.0 | 07/09/2026 | Accueil d'exploration, recherche de films, rangées personnelles, sagas, streaming du soir |
...
Onze versions publiées, chacune associée à un tag et à une release.
