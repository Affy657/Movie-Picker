...
| [`01-planification.md`](01-planification.md) | **C3.1** : un cycle en V par version et un flux pour le run, alternatives écartées, board GitHub Projects, rétroplanning et Gantt, les cinq phases par version datées, les versions comme lots avec leur effort réel, ressources humaines (une personne, quatre rôles), matérielles et financières réelles, matrice RACI par rôle et prise en compte du handicap, 7 points de vigilance |
