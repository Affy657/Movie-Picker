...
| 10 | **Mémoriser les numéros de page des annexes** | A1 architecture = 16 ; A2 arbitrages de réserve = 17 ; A3 chaîne = 18 ; A4 journal des versions = 19 ; A5 retours utilisateurs = 20 ; A6 RACI complète = 21 ; A7 infrastructure = 22. En mode présentateur, taper le numéro puis `Entrée` |
| 10 bis | ~~Décider si les chiffres d'activité sont réancrés une dernière fois~~ ✅ **Décidé le 12/09 : réancrage au 12/09, v1.6.0**, chapitre par chapitre au fil de la reconstruction. Chapitres 2 et 3 réancrés (11 versions, 1 070 commits, 95 jours actifs, 187 fusions, 21 comptes, 81 items produit dont 58 hors chiffrage, −3 % de charge). Les chapitres 4 à 8 gardent le 05/09 jusqu'à leur reprise ; à la fin, rejouer § 5.1 de `PASSATION.md` une dernière fois la veille de l'oral si la v1.6.0 est taguée et poussée entre-temps |
