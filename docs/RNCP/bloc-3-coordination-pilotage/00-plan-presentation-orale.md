...
| 5 | Le planning : chaque version parcourt les cinq phases | 1:10 | Gantt en HTML et CSS, une ligne par version du 16 février au 16 septembre 2026, chaque ligne découpée en étude, conception, réalisation, restitution (losange de release) et mesure en production, plus les versions correctives en lignes « run » et les 4 jalons du titre. Dire que les lignes se **chevauchent** : l'étude de la suivante pendant la mesure de la précédente |
