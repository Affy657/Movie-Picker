...
| 3 | Les ressources nécessaires | C3.1 | 7 |
| 4 | L'outil de suivi de projet | C3.2.1 | 10 |
| 5 | Un cas d'arbitrage rencontré au cours du projet | C3.2.2 | 15, 16 |
| 6 | L'affectation des missions réalisée au cours du projet | C3.3.1 | 17 |
| 7 | Le ou les styles managériaux utilisés | C3.3.1 | 18 |
| 8 | Les outils de communication utilisés et leurs objectifs | C3.3.1 | 19 |
| 9 | L'évaluation des besoins en compétences via grille | C3.3.2 | 22 |
| 10 | Le plan de développement des compétences | C3.3.2 | 23 |
...
Répartition volontaire : les trois compétences éliminatoires absorbent **18 minutes 50 sur 30**, soit 63 %. Les quatre non éliminatoires se partagent 11 minutes 10. Une diapositive dure en moyenne 56 secondes hors démonstration : le support a été épuré pour que chaque diapositive porte une preuve visuelle, jamais un paragraphe.
...
Placées après la diapositive 27, jamais présentées, appelées seulement si une question les demande.

| # | Page | Contenu |
|:-:|:----:|---------|
| A1 | **28** | Architecture technique : déploiement, découpage hexagonal de l'API, volume et qualité |
...
| Qu'auriez-vous fait différemment ? | Réponse préparée sur la diapositive 20, avec une décision précise et son coût |
...
|---------|----------|------|
| `01-planification.md` | Diapos 4 à 9, C3.1 | ✅ Produit |
| `02-suivi-indicateurs.md` | Diapos 10 à 14, C3.2.1 | ✅ Produit |
| `03-arbitrage.md` | Diapos 15 et 16, C3.2.2 | ✅ Produit |
| `04-management-equipe.md` | Diapos 17 à 20, C3.3.1 | ✅ Produit |
| `05-competences.md` | Diapos 21 à 23, C3.3.2 | ✅ Produit |
| `06-comptes-rendus.md` | Diapos 24 à 26, C3.4.1 | ✅ Produit |
| `07-demonstration.md` | Diapos 2 et 27, et la démonstration en direct, C3.4.2 | ✅ Produit |
| `slides/slides.md` | Le support complet | ✅ **35 diapositives** : les 27 présentées et les 8 annexes |
...
Deux actions hors rédaction restent à mener : structurer le tableau GitHub Projects et en produire une capture pour la diapositive 10, et relever une capture de facturation GCP et AWS pour étayer la ligne « coût réel » de la diapositive 13.
