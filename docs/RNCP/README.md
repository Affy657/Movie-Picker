...
> Les documents **produit / technique** (spec, roadmaps, architecture, cartes de livraison V1) restent dans [`../`](../) et [`archive/docs/v1-produit/`](../../archive/docs/v1-produit/) ; ils sont **référencés** depuis ce dossier mais ne sont pas des livrables RNCP au sens strict.
...
|------|----------|------------------|------|
| **1** | Cadrer un projet de développement | C1.1.1, C1.2.2, C1.3.2, C1.4.1, C1.6 | ✅ **Remis**, archivé dans [`archive/docs/RNCP/bloc-1-cadrage/`](../../archive/docs/RNCP/bloc-1-cadrage/) |
...
| **3** | Coordonner et piloter | C3.1, C3.2.1, C3.4.2 | ✅ **Support complet** (7 chapitres, 30 diapositives), oral le 16/09/2026 |
