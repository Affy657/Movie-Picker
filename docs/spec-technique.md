...
| CI/CD : tests, build, déploiement | GitHub Actions (test, build, push image, deploy) |
...
- CI/CD: GitHub Actions — test, build front & back, build Docker image, push to Artifact Registry, deploy to Cloud Run; CloudFront invalidation if needed.  
