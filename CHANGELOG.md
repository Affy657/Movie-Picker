...
- **Échap ne ferme plus que le menu ouvert, pas la fenêtre qui le contient** : dans les paramètres d'une soirée, Échap sur le sélecteur d'emoji fermait toute la feuille des paramètres. Il ne ferme plus que le sélecteur, comme les listes déroulantes, les bulles d'aide et le menu des cartes de film, et un clic ailleurs dans la feuille referme aussi le sélecteur.
