...
- **Les menus et sélecteurs se pilotent au clavier** : le menu « ⋮ » d'un film et le survol « Proposer dans une soirée » se parcourent aux flèches, Home et End, et Échap les ferme en rendant le focus à leur bouton, et le menu du compte comme celui de l'agenda gagnent les mêmes flèches ; le choix d'emoji du thème et les pastilles de couleur d'accent sont des groupes de boutons radio de 44 px, où les flèches changent la sélection sans fermer la grille. Chaque champ de formulaire (création de soirée, paramètres d'une soirée, compte, mots de passe, proposition d'idée) annonce son aide et son erreur au lecteur d'écran, et l'erreur porte une icône partout, plus seulement dans les paramètres d'une soirée. Le champ de recherche prend le même habillage que les autres champs, un champ ou un menu désactivé se grise, et les boutons ne se soulèvent plus au survol quand le système demande moins d'animations.
