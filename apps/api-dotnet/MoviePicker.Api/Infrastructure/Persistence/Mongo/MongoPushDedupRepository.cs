...
{
    private readonly IMongoCollection<PushDedupMarkerDocument> _collection;

    public MongoPushDedupRepository(IMongoDatabase database)
    {
        _collection = database.GetCollection<PushDedupMarkerDocument>("push_dedup_markers");
    }
