...
public interface IParticipantRepository
{
    ...
    Task<IReadOnlyList<Participant>> ListByUserIdAsync(string userId, int limit = 0, CancellationToken ct = default);

    Task<IReadOnlyList<Participant>> ListByUserIdsAsync(
