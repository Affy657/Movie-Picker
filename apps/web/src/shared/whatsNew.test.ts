...
describe('shouldShowWhatsNewNavChip', () => {
  ...
  it('reste masquée pour un compte créé à partir du lendemain de la 1.4.0', () => {
    expect(
      shouldShowWhatsNewNavChip(
  ...
  it('s’affiche pour un compte créé le jour de la livraison de la 1.4.0', () => {
    expect(
      shouldShowWhatsNewNavChip(
  ...
  it('reste masquée avant la livraison de la 1.4.0', () => {
