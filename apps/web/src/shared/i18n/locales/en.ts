...
export const en: Locale = {
  ...
  profile: {
    ...
    movies: {
      ...
      pageSubtitle: '{{count}} movies proposed',
      pageWinnersOne: ', {{count}} winner',
      pageWinners: ', {{count}} winners',
      loadError: "Could not load this user's proposed movies.",
      listAria: 'Proposed movies',
      emptyTitle: 'No movies proposed yet',
      emptyMessage: "This person hasn't proposed any movie in an event yet.",
      loadMoreOne: 'Load the remaining movie',
      loadMore: 'Load {{count}} remaining movies',
      toolbar: {
        searchLabel: 'Search among proposed movies',
