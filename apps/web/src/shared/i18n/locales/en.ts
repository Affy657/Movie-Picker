...
export const en: Locale = {
  ...
  events: {
    ...
    ratings: {
      rateAction: 'Rate this movie',
      myRating: 'Your rating {{value}}',
      groupAria: 'See the ratings, average {{average}}, {{count}}',
      countOne: '1 rating',
      countMany: '{{count}} ratings',
      dialogTitleRate: 'Rate this movie',
      dialogTitleRead: "The night's ratings",
      starsLabel: 'Your rating',
      starAriaOne: 'Rate 1 star',
      starAriaMany: 'Rate {{count}} stars',
      pickHint: 'Tap a star',
      halfHint: 'Tap the same star again for a half star.',
      listTitle: "The night's ratings",
      average: 'Average {{value}}',
      nobodyYet: 'Nobody has rated this movie yet.',
      pending: 'Not rated yet',
      you: 'You',
      save: 'Save',
      clear: 'Clear my rating',
      saveError: "Your rating wasn't saved. Try again.",
      clearError: "Your rating wasn't cleared. Try again.",
    },
    recap: {
      eyebrow: 'The night recap',
      documentTitle: '{{title}}, the recap',
      proposedOne: '1 movie proposed',
      proposedMany: '{{count}} movies proposed',
      rateAction: 'Rate',
      viewRecap: 'View the recap',
      viewNight: 'View the night',
      ctaTitle: 'What about the next one?',
      ctaText:
        'On Movie Picker, everyone proposes movies, everyone votes and the wheel decides. Free, nothing to install.',
      ctaButton: 'Host your own',
      notChosenTitle: 'The movie is not chosen yet',
      notChosenText: 'The recap of “{{title}}” comes after the night, once the movie is drawn.',
      noMovieTitle: 'Over without a movie',
      noMovieText: '“{{title}}” ended without a chosen movie, so there is no recap.',
      notFoundTitle: 'Recap not found',
      notFoundText: 'This link leads to no night. It may have been deleted.',
      errorTitle: 'The recap could not be loaded',
      errorText: 'Check your connection, then try again.',
      share: {
        dialogTitle: 'Share the recap',
        shareText: 'We watched {{movie}} during {{title}}, here is the recap!',
        shareTextNoMovie: 'Here is the recap of {{title}}!',
        qrHint: 'Open the camera to open the recap on mobile.',
        noRating: 'No rating yet',
      },
      story: {
        tab: 'Story',
        familyFilms: 'The movies',
        familyFilm: 'One movie',
        familyFilmOne: 'The movie',
        familyRatings: 'The ratings',
        familyAria: 'Story type',
        carouselAria: 'Stories of the night',
        carouselRole: 'carousel',
        previous: 'Previous story',
        next: 'Next story',
        position: '{{index}} of {{total}} movies',
        preparing: 'Preparing the image…',
        preview: 'Story of {{title}}',
        hint: 'In story format, for Instagram, Snapchat or WhatsApp.',
        hintSwipe: 'Swipe to move from one story to the next.',
        share: 'Share',
        download: 'Download the image',
        errorTitle: 'The image could not be created',
        errorText: 'The recap link is still shareable from the Link tab.',
        qrCaption: 'See the recap',
        footer: "The recap and everyone's ratings",
        moreParticipants: 'and {{count}} more participants',
      },
    },
    pending: {
  ...
  apiErrors: {
    ...
    rating_own_participation_only: 'You can only rate for your own participation.',
    rating_only_after_event: 'A movie can be rated once the night is over.',
    rating_only_chosen_movie: 'Only the chosen movies of the night can be rated.',
    rating_out_of_range: 'The rating must be between 1 and 10.',
  ...
  profile: {
    ...
    movies: {
      ...
      seeAll: 'See all',
      ownerRating: "@{{handle}}'s rating: {{value}}",
