export const fr = {
  ...
  tech: {
    ...
    trajectory: {
      ...
      v19What: 'V1.9',
      v19Detail:
        "Une vraie connexion temps réel à la place du rafraîchissement périodique, une soirée lisible hors-ligne et cadrée par le thème de l'hôte, puis la double authentification et la palette de commandes.",
      v19Hint:
