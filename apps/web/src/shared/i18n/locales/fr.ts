export const fr = {
  ...
  tech: {
    ...
    ci: {
      ...
      caption:
        "Un seul job réunit navigateur réel et vraie base, e2e mongo, et il bloque les deux déploiements. Le dernier maillon, lui, vérifie que les déploiements ont eu lieu, pas seulement qu'ils n'ont pas échoué.",
