export const fr = {
  ...
  profile: {
    ...
    movies: {
      ...
      pageSubtitle: '{{count}} films proposés',
      pageWinnersOne: ', {{count}} gagnant',
      pageWinners: ', {{count}} gagnants',
      loadError: 'Impossible de charger les films proposés par cet utilisateur.',
      listAria: 'Films proposés',
      emptyTitle: 'Aucun film proposé pour le moment',
      emptyMessage: "Cette personne n'a encore proposé aucun film dans une soirée.",
      loadMoreOne: 'Charger le film restant',
      loadMore: 'Charger les {{count}} films restants',
      toolbar: {
        searchLabel: 'Rechercher parmi les films proposés',
