...
describe('TrailerModal', () => {
  it('affiche le titre et le lecteur quand open + URL valide', () => {
    wrap(
      <TrailerModal open movieTitle="Inception" trailerUrl={YT_URL} onClose={vi.fn()} />
    );
  ...
  it('ne rend pas le contenu si trailerUrl est null', () => {
    wrap(
      <TrailerModal open movieTitle="Inception" trailerUrl={null} onClose={vi.fn()} />
    );
  ...
  it('appelle onClose au clic sur le bouton de fermeture', () => {
    const onClose = vi.fn();
    wrap(
      <TrailerModal open movieTitle="Dune" trailerUrl={YT_URL} onClose={onClose} />
    );
