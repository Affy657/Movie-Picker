...
export default function DonatePage() {
  ...
  return (
    <PageLayout className={styles.layout}>
      ...
      <p className={styles.intro}>{t('donate.intro')}</p>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>{t('donate.costsTitle')}</h2>
      ...
      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>{t('donate.noPerksTitle')}</h2>
        <p>{t('donate.noPerksBody')}</p>
      </section>

      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>{t('donate.badgeTitle')}</h2>
