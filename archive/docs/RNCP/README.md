...
> **Dossier archivé le 16 septembre 2026.** Les quatre blocs sont remis et l'oral du Bloc 3 a eu lieu ce jour-là. Plus rien n'est attendu ici ; les documents produit et technique vivants restent dans [`docs/`](../../../docs/).
...
> Les documents **produit / technique** (spec, roadmaps, architecture, cartes de livraison V1) restent dans [`docs/`](../../../docs/) et [`archive/docs/v1-produit/`](../v1-produit/) ; ils sont **référencés** depuis ce dossier mais ne sont pas des livrables RNCP au sens strict.
...
|------|----------|------------------|------|
| **1** | Cadrer un projet de développement | C1.1.1, C1.2.2, C1.3.2, C1.4.1, C1.6 | ✅ **Remis**, oral du 11/06/2026 ([`bloc-1-cadrage/`](bloc-1-cadrage/)) |
| **2** | Concevoir et développer | C2.2.1, C2.2.2, C2.2.3, C2.3.1 | ✅ **Remis** ([`dossier-bloc-2.md`](bloc-2-conception-developpement/dossier-bloc-2.md)) |
| **3** | Coordonner et piloter | C3.1, C3.2.1, C3.4.2 | ✅ **Présenté** à l'oral du 16/09/2026, 22 diapositives ([`slides-bloc3.pdf`](bloc-3-coordination-pilotage/slides/slides-bloc3.pdf)) |
| **4** | Maintenir en condition opérationnelle | C4.1.2, C4.2.1, C4.3.2 | ✅ **Remis** ([`dossier-bloc-4.pdf`](bloc-4-mco/dossier-bloc-4.pdf)) |
