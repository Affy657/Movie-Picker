...
│  └─ ci-identity/         le compte que les workflows assument, la fédération GitHub (pool et provider OIDC) et chaque droit du compte
└─ environments/
...
### Identités (lot 5, posé le 2026-09-20)

Deux comptes de service, aucune clé : `gcloud iam service-accounts keys list --managed-by=user` ne rend rien sur aucun compte du projet, et rien ne doit en créer.
