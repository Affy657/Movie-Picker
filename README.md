...
- **V1 (secrets, CORS, cookies, rate limits, logs)** : [`docs/v1-produit/deploiement-secrets-ci.md`](docs/v1-produit/deploiement-secrets-ci.md) si besoin au-delà du README / `.env.example`.
